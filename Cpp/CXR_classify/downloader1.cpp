...
Downloader1::Downloader1(ConfigHandler * configHandler) : Runnable(configHandler)
{
    Downloader1::filenameRelPath = "./" + configHandler->getTgzFilename();
    Downloader1::datasetType = configHandler->getDatasetType();
}

void Downloader1::run()
{
...
quint64 Downloader1::getTgzSize()
{
