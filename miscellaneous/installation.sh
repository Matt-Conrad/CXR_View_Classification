...
sshpass -p 'password' ssh -o 'StrictHostKeyChecking no' matt@192.168.61.130 'echo password | sudo -S chmod u+x /mnt/hgfs/SharedFolder_Guest/miscellaneous/cppSetup.sh'
sshpass -p 'password' ssh -o 'StrictHostKeyChecking no' matt@192.168.61.130 'echo password | sudo -S /mnt/hgfs/SharedFolder_Guest/miscellaneous/cppSetup.sh'
