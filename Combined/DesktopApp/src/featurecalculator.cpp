...
Processor::Processor(std::string filePath, ConfigHandler * configHandler, DatabaseHandler * dbHandler)
{
    Processor::filePath = filePath;
    Processor::configHandler = configHandler;
    Processor::dbHandler = dbHandler;
}
